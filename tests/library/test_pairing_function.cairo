...
@view
func test_cantor_pair{syscall_ptr : felt*, range_check_ptr, pedersen_ptr : HashBuiltin*}():
    let x = Uint256(0, 0)
    let y = Uint256(0, 0)
    let z = Uint256(0, 0)
...
@view
func test_cantor_unpair{syscall_ptr : felt*, range_check_ptr, pedersen_ptr : HashBuiltin*}():
    alloc_locals
